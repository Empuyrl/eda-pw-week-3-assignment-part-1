...
let favoriteFoods = ['ramen', 'pasta', 'fruit', 'eggs'];
...
console.log(`Added an animal to beginning: walrus`);

// 4.c. TODO: Add a food at the beginning of the array & log the array
favoriteFoods.unshift('pizza');
console.log('Added a favorite food to the beginning: pizza');
...
let favoriteThings = ['ramen', 'pizza', 'fruit', 'eggs', 'fish', 'cat', 'bird', 'dog'];
console.log('Favorite things are', favoriteThings);

favoriteFoods.push(...animalArray);
